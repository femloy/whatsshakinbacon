function scr_player_jump()
{
	...
	if animation_end() && sprite_index = spr_player_piledrivergetup
	{
		image_index = 0
		sprite_index = spr_player_fall
	}
	
	if freefalling >= 60 && sprite_index == spr_player_fall
		sprite_index = spr_player_fallfast1
	if freefalling >= 60 * 2 && sprite_index == spr_player_fallfast1
