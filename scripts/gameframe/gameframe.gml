...
function gameframe_caption_draw_caption_text_default(__x, __y, __width, __height) {
	...
	draw_text_ext_transformed((__x + ((gameframe_caption_text_align * __textWidth) div 2)) + 48, __y + ((__height - string_height_ext(_text, -1, __textWidth) * _dpiScale) div 2), _text, -1, __textWidth, _dpiScale, _dpiScale, 0);
